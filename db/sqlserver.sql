...
CREATE TABLE [dbo].[move_tablename]  (
...
CREATE CLUSTERED INDEX [IDX_TABLENAME]
	ON [dbo].[move_tablename]([tablename])
GO

INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230800_1', 0, N'f:/scanimage/nz')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230800_2', 0, N'f:/scanimage/sy')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230800_3', 0, N'f:/scanimage/wz')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230802_1', 0, N'f:/scanimage/230802nz')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230803_1', 0, N'f:/scanimage/230803nz')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230804_1', 0, N'f:/scanimage/230804nz')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230805_1', 0, N'f:/scanimage/230805nz')
GO
INSERT INTO [dbo].[move_tablename]([tablename], [state], [path])
  VALUES(N'tab_item_230811_1', 0, N'f:/scanimage/230811nz')
GO

CREATE TABLE [dbo].[move_itemover](
    [tybm] [varchar](500) NULL,
    [state] [varchar](50) NULL
    ) ON [PRIMARY]

GO

CREATE CLUSTERED INDEX [IDX_OVERTYBM]
    ON [move_itemover]([tybm] ASC)
GO

CREATE TABLE [dbo].[move_itemoverfile](
    [tybm] [varchar](500) NULL,
    [state] [varchar](50) NULL
    ) ON [PRIMARY]
...
CREATE CLUSTERED INDEX [IDX_OVERTYBMFILE]
    ON [move_itemoverfile]([tybm] ASC)
GO
